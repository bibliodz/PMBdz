...
class Dailymotion_api
{
    ...
    {
        if ($session['grant_type'] != Dailymotion_api::GRANT_TYPE_CLIENT_CREDENTIALS)
        {
    ...
    protected function httpRequest($url, $payload, $headers = null, &$status_code = null, &$response_headers = null)
    {
        ...
        (
            ...
            (
                ...
                CURLOPT_USERAGENT => sprintf('Dailymotion-PHP/%s (PHP %s; %s)', Dailymotion_api::VERSION, PHP_VERSION, php_sapi_name()),
                CURLOPT_HEADER => true,
