...
<xsl:template name="electronic_location">
	<xsl:for-each select="./f[@c='856']">
		<xsl:element name="f">	
			<xsl:attribute name="c">956</xsl:attribute>
