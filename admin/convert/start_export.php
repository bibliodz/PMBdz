...
// +-------------------------------------------------+
// $Id: start_export.php,v 1.17 2013-01-23 15:24:17 dgoron Exp $
...
if ($first!=1) {
	if ($output_params["SPECIALDOCTYPE"] == "yes") {
		if (mysql_num_rows($resultat) > 0) {
			$id_notice = mysql_result(mysql_query($requete),0,"notice_id");	
			$output_params["DOCTYPE"] = mysql_result(mysql_query("select typdoc from notices where notice_id='".$id_notice."'"),0,0);
		}
	}
