...
// +-------------------------------------------------+
// $Id: encaissement.php,v 1.12 2014-01-07 15:44:04 ngantier Exp $
...
<script language='JavaScript'>
	...
	printer_print_ticket('$base_path/ajax.php?module=circ&categ=zebra_print_pret&sub=transacash_ticket&transacash_id=!!transacash_id!!');
</script>	";
