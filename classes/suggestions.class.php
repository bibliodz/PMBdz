...
// +-------------------------------------------------+
// $Id: suggestions.class.php,v 1.37 2013-04-16 08:16:41 mbertin Exp $
...
class suggestions{
	...
	static function getNbSuggestions($id_bibli=0, $statut='-1', $num_categ='-1', $mask, $aq=0, $location=0, $user_input='',$source=0, $user_id=0, $user_statut='-1') {
