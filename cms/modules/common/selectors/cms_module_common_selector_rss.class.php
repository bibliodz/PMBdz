...
// +-------------------------------------------------+
// $Id: cms_module_common_selector_rss.class.php,v 1.2 2012-11-09 14:12:45 arenou Exp $

if (stristr($_SERVER['REQUEST_URI'], ".class.php")) die("no access");
//require_once($base_path."/cms/modules/common/selectors/cms_module_selector.class.php");
class cms_module_common_selector_rss extends cms_module_common_selector{
	...
	public function save_form(){
		$this->parameters = $this->get_value_from_form("url");
