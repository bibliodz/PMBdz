...
// +-------------------------------------------------+
// $Id: cms_module_common_selector_type_article.class.php,v 1.2 2012-11-09 14:12:45 arenou Exp $

if (stristr($_SERVER['REQUEST_URI'], ".class.php")) die("no access");

class cms_module_common_selector_type_article extends cms_module_common_selector_type_editorial{	
	...
	protected function get_sub_selectors(){
		...
		$sub_selectors[]='cms_module_common_selector_article';
