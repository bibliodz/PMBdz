...
// +-------------------------------------------------+
// $Id: cms_module_common_selector_type_section_filter.class.php,v 1.1 2012-12-17 10:35:14 arenou Exp $

if (stristr($_SERVER['REQUEST_URI'], ".class.php")) die("no access");

class cms_module_common_selector_type_section_filter extends cms_module_common_selector_type_editorial{	
