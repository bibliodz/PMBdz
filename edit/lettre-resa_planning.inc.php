...
// +-------------------------------------------------+
// $Id: lettre-resa_planning.inc.php,v 1.2 2007-03-10 09:25:49 touraine37 Exp $
...
switch($pdfdoc) {
	...
	default :
		...
		$rqt = "select resa_idempr from resa_planning where id_resa='$id_resa' ";
		$res = mysql_query ($rqt, $dbh) ;
		$resa_validee=mysql_fetch_object($res);
		lettre_resa_planning_par_lecteur($resa_validee->resa_idempr) ;
