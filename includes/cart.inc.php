...
// +-------------------------------------------------+
// $Id: cart.inc.php,v 1.75 2013-07-15 13:36:21 dgoron Exp $
				...
				switch (action) {
					case 'add_item':
						if (data.res_pointage == 1) {
							...
							document.getElementById('caddie_'+num_caddie+'_item_'+num_item).onclick= function() {del_pointage_item(num_caddie,num_item);};
						} else {
							...
							document.getElementById('caddie_'+num_caddie+'_item_'+num_item).onclick= function() {add_pointage_item(num_caddie,num_item);};
						}
						break;
					case 'del_item':
						if (data.res_pointage == 1) {
