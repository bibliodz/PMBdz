...
// +-------------------------------------------------+
// $Id: consolidation.inc.php,v 1.14 2013-04-11 08:19:45 mbertin Exp $
...
function aff_explnum_localisation($param,$parser){
	...
	if($tab['explnum'] && is_array($tab['explnum'][0])){
...
/**
 * Arboressance du document numérique dans le répertoire
 */
...
/**
 * Extention du document numérique
 */
...
function aff_type_page($param, $parser){
	...
	//Document numérique
	if(strpos($url,'doc_num.php') || strpos($url,'visionneuse.php')){
		return $page['doc_num'];
	}
