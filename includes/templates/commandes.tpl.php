...
// +-------------------------------------------------+
// $Id: commandes.tpl.php,v 1.55 2013-04-11 08:47:35 mbertin Exp $
...
switch ($acquisition_gestion_tva) {
	case '1' :
		$modif_cde_form.= "
						<th width='6%'>".htmlentities($msg['acquisition_act_tab_priht'], ENT_QUOTES, $charset)."<br />".htmlentities($msg['acquisition_act_tab_prittc'], ENT_QUOTES, $charset)."</th>
	...
	case '2' :
		$modif_cde_form.= "
						<th width='6%'>".htmlentities($msg['acquisition_act_tab_prittc'], ENT_QUOTES, $charset)."<br />".htmlentities($msg['acquisition_act_tab_priht'], ENT_QUOTES, $charset)."</th>
						<th width='20%'>".htmlentities($msg['acquisition_act_tab_typ'], ENT_QUOTES, $charset)."<br />".htmlentities($msg['acquisition_tva'], ENT_QUOTES, $charset)." / ".htmlentities($msg['acquisition_remise'], ENT_QUOTES, $charset)."</th>";
		break;	
	default :
		$modif_cde_form.= "
