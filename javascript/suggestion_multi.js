...
function add_line(nb_ligne){
	...
	var td_com_gestion = document.createElement("td");
	var area_com_gestion = document.createElement("textarea");
	area_com_gestion.setAttribute("id","sugg_com_gestion_"+nb);
	area_com_gestion.setAttribute("name","sugg_com_gestion_"+nb);
	td_com_gestion.appendChild(area_com_gestion);
...
function disableAll(nbligne){
	...
	document.getElementById("sugg_com_gestion_"+nbligne).disabled = true;
...
function enableAll(nbligne){
	...
	document.getElementById("sugg_com_gestion_"+nbligne).disabled = false;
