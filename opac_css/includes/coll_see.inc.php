...
// +-------------------------------------------------+
// $Id: coll_see.inc.php,v 1.50 2014-02-11 13:02:57 dbellamy Exp $
...
if($id) {
	...
	if($nbr_lignes) {
		...
		print "<div id='navbar'><hr /><center>".printnavbar($page, $nbepages, "./index.php?lvl=coll_see&id=$id&page=!!page!!&nbr_lignes=$nbr_lignes&l_typdoc=".rawurlencode($l_typdoc))."</center></div>\n";
