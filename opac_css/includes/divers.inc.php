...
// +-------------------------------------------------+
// $Id: divers.inc.php,v 1.13 2013-12-19 09:44:41 dgoron Exp $
...
function formatdate_input($date_a_convertir) {
	...
	$resultatdate=mysql_query("select date_format('".$date_a_convertir."', '".$msg["format_date_input_model"]."') as date_conv ");
	$date_conv=mysql_result($resultatdate,0,0);
	return $date_conv ;
}
