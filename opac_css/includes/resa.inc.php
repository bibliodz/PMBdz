...
// +-------------------------------------------------+
// $Id: resa.inc.php,v 1.50 2014-01-24 14:24:50 dgoron Exp $
...
if ($opac_resa) {
	...
	if ($delete && ($id_notice || $id_bulletin)) {
		...
		if($pmb_transferts_actif){
			...
			resa_trans='".$suppr_id_resa."' and etat_transfert=0
			";
			mysql_query($req, $dbh);
		}
		...
		if ($cb_recup) {
			...
			} else alert_mail_users_pmb($id_notice, $id_bulletin, $_SESSION["id_empr_session"], 2) ;
