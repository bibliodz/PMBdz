...
// +-------------------------------------------------+
// $Id: serie_see.inc.php,v 1.22 2013-11-06 16:26:42 dgoron Exp $
...
if($id) {
	...
	print "	<div id='aut_details_liste'>\n
		...
		if($nbr_lignes) {
			...
			print "<div id='navbar'><hr /><center>".printnavbar($page, $nbepages, "./index.php?lvl=serie_see&id=$id&page=!!page!!&nbr_lignes=$nbr_lignes&l_typdoc=".rawurlencode($l_typdoc))."</center></div>\n";
		} else {
