...
// +-------------------------------------------------+
// $Id: show_cart.inc.php,v 1.44 2014-01-30 11:11:44 abacarisse Exp $
...
if (count($cart_)) {
	...
	print "
		...
		<input type='button' id='list_lecture_cart_checked_all' class='bouton' value=\"".$msg["list_lecture_cart_checked_all"]."\" title=\"".$msg["list_lecture_cart_checked_all_title"]."\" onClick=\"setCheckboxes('cart_form', 'notice', true); return false;\" />
	...
	if($opac_resa){
		...
		if($opac_resa_popup){
			...
			print "<input type='button' id='show_cart_reserve' class='bouton' value=\"".$msg["show_cart_reserve"]."\" title=\"".$msg["show_cart_reserve_title"]."\" onClick=\"document.location='./index.php?lvl=resa_cart&sub=resa_cart'\" />&nbsp
				   <input type='button' id='show_cart_reserve_checked' class='bouton' value=\"".$msg["show_cart_reserve_checked"]."\" title=\"".$msg["show_cart_reserve_checked_title"]."\" onClick=\"document.cart_form.action='./index.php?lvl=resa_cart&sub=resa_cart_checked';if(confirm_transform()) document.cart_form.submit(); else return false;\" /><br /><br />";
		}	
