...
// +-------------------------------------------------+
// $Id: subcoll_see.inc.php,v 1.48 2014-02-11 13:02:57 dbellamy Exp $

if (stristr($_SERVER['REQUEST_URI'], ".inc.php")) die("no access");

require_once($base_path.'/includes/templates/subcollection.tpl.php');
...
if($id) {
	...
	print pmb_bidi($ourSubcoll->print_resume());
	
	$aut_link= new aut_link(AUT_TABLE_SUB_COLLECTIONS,$id);
	...
	print "<h3>$msg[available_docs_in_subcoll]</h3>\n";
	...
	if(!$nbr_lignes) {
		...
		if($nbr_lignes) {
			...
			$_SESSION["notice_view".$n]["search_mod"]="subcoll_see";
			...
			print "<div id='navbar'><hr /><center>".printnavbar($page, $nbepages, "./index.php?lvl=subcoll_see&id=$id&page=!!page!!&nbr_lignes=$nbr_lignes&l_typdoc=".rawurlencode($l_typdoc))."</center></div>\n";
