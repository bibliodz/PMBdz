...
// +-------------------------------------------------+
// $Id: sort.tpl.php,v 1.7 2014-01-17 10:32:30 dgoron Exp $
	...
	function sortSupprIds(the_form, the_objet) {
		...
		return ids;
		   ...
		   <table width='100%'>
				...
				<tr>
					<td><br /><input type='button' class='bouton' value=\"".$msg["suppr_elts_sort_coch"]."\" onClick=\"if (verifCheckboxes('cases_a_cocher','cases_suppr')){ !!action_suppr_tris!! return false;}\">&nbsp;
