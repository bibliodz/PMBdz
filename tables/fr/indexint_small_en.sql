...
-- +-------------------------------------------------+
-- $Id: indexint_small_en.sql,v 1.7 2012-12-05 09:41:50 mbertin Exp $
...
INSERT INTO `pclassement` (`id_pclass`, `name_pclass`, `typedoc`) VALUES (1,'English light Dewey','abcdefgijklmr');
...
-- Dump completed on 2012-11-29  9:16:42
